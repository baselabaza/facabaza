...
chsource = Redis:get(Fast..'chsource') or "JJXXH"
devsource = Redis:get(Fast..'devsource') or "B100Q"
devsource2 = Redis:get(Fast..'devsource') or "JOK_XII"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,656329268,5686381992,5595392404}
...
if text == 'ابديت' and tonumber(senderr) == tonumber(656329268) then
...
if tonumber(senderr) == 656329268 then
msg.Name_Controller = 'مـلـك الـتـلـجـرام 𓋖'
msg.The_Controller = 1
elseif tonumber(senderr) == 5686381992 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 5595392404 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(656329268) then
...
if text == 'باسل' or text == 'اباظة' or text == 'بسبس'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'ᴅᴇᴠ ᴀʙᴀᴢᴀ', url = 't.me/B100Q'}, 
},
}
}
return send(msg_chat_id,msg_id,"[ᴀʙᴀᴢᴀ](tg://user?id=656329268)","md",true, false, false, true, reply_markup)
end

if text == 'جوكر' or text == 'الجوكر'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'ᴅᴇᴠ ᴊᴏᴋᴇʀ', url = 't.me/JOK_XII'}, 
},
}
}
return send(msg_chat_id,msg_id,"[ᴊᴏᴋᴇʀ](tg://user?id=5686381992)","md",true, false, false, true, reply_markup)
end
...
if text == 'مصنع السورس' or text == 'المصنع' or text == 'مصنع'  then
  ...
  data = {
  {
  {text = '𝘈𝘉𝘈𝘡𝘈 𝘍𝘈𝘊𝘛𝘖𝘙𝘠 ² 𐂡', url = 'https://t.me/XAbazAXbot'}, 
  },
  }
  }
  return send(msg_chat_id,msg_id,"[𝘈𝘉𝘈𝘡𝘈 𝘍𝘈𝘊𝘛𝘖𝘙𝘠 ² 𐂡](https://t.me/XAbazAXbot)","md",true, false, false, true, reply_markup)
  end
if text == "صورتي" then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(656329268) then
local txx = "\n"
...
{
{text = '- لـصـنـع بـوت مـجـانـي 🤖.',url='httpضs://t.me/XAbazAXbot'},
},
{
