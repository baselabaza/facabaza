...
return {
Lock     = '\n*ま بواسطه ← *'..UserInfousername..'\n*'..Textdata..'\nまخاصيه المسح *',
unLock   = '\n*ま بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '\n*ま بواسطه ← *'..UserInfousername..'\n*'..Textdata..'\nまخاصيه الكتم *',
lockKid  = '\n*ま بواسطه ← *'..UserInfousername..'\n*'..Textdata..'\nまخاصيه التقييد *',
lockKick = '\n*ま بواسطه ← *'..UserInfousername..'\n*'..Textdata..'\nまخاصيه الطرد *',
Reply    = '\n*ま المستخدم ← *'..UserInfousername..'\n*'..Textdata..'*'
}
end
if Dev(msg) then
if text == "تحديث" or text == "اعاده التشغيل ま" then
bot.sendText(data.chat_id,data.id,"ま تمت اعاده تشغيل الملفات بنجاح ✅")
dofile('Fast.lua')  
return false 
end
...
return send(data.chat_id,data.id,Reply_Status(Info_User,'ま تم حظره من الصانع').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Fast..'BaN:In:Tuasl',Info_User)  
return send(data.chat_id,data.id,Reply_Status(Info_User,'ま تم الغاء حظره من الصانع ').Reply,"md",true)  
end 
end
end
if text == "ま الغاء الامر" then
...
return send(data.chat_id,data.id,"ま تم الغاء الامر بنجاح")
end
if text == "/start" then
Redis:del(Fast..data.sender_id.user_id.."bottoken")
Redis:del(Fast..data.sender_id.user_id.."botuser")
...
data = {
{
{text = 'ま صنع بوت',type = 'text'},{text = 'ま حذف بوت',type = 'text'},
},
{
{text = 'ま تشغيل بوت',type = 'text'},{text = 'ま ايقاف بوت',type = 'text'},
},
{
{text = 'ま تفعيل الاشتراك الاجباري',type = 'text'},{text = 'ま تعطيل الاشتراك الاجباري',type = 'text'},
},
{
{text = 'ま تفعيل الوضع المجاني',type = 'text'},{text = 'ま تعطيل الوضع المجاني',type = 'text'},
},
{
{text = 'ま الاحصائيات',type = 'text'},{text = 'ま الاسكرينات المفتوحه',type = 'text'},
},
{
{text = 'ま البوتات الوهميه',type = 'text'},{text = 'ま حذف البوتات الوهميه',type = 'text'},
},
{
{text = 'ま تنظيف عميق',type = 'text'},
},
{
{text = 'ま تفعيل التواصل',type = 'text'},{text = 'ま تعطيل التواصل',type = 'text'},
},
{
{text = 'ま عدد البوتات',type = 'text'},{text = 'ま فحص',type = 'text'},
},
{
{text = 'ま تقرير البوتات',type = 'text'},
},
{
{text = 'ま اذاعه',type = 'text'},{text = 'ま اذاعه بالتوجيه',type = 'text'},
},
{
{text = 'ま اذاعه عام للمجموعات',type = 'text'},{text = 'ま اذاعه عام للمشتركين',type = 'text'},
},
{
{text = 'ま تعيين قناه البوت',type = 'text'},
},
{
{text = 'ま تحديث المصنوعات',type = 'text'},{text = 'ま تشغيل البوتات',type = 'text'},
},
{
{text = 'اعاده التشغيل ま',type = 'text'},
},
{
{text = 'ま الغاء الامر',type = 'text'},
},
}
}
send(data.chat_id,data.id,"ま اهلا بك عزيزي المطور الاساسي \n","md",true, false, false, true, reply_markup)
return false 
end
---
if text and text:match("^رفع مطور (%d+)$") then
Redis:sadd(Fast.."Dev",text:match("^رفع مطور (%d+)$"))
send(data.chat_id,data.id,'ま تم رفع العضو مطور ف الصانع بنجاح ',"md",true)  
return false 
end
if text and text:match("^تنزيل مطور (%d+)$") then
Redis:srem(Fast.."Dev",text:match("^تنزيل مطور (%d+)$"))
send(data.chat_id,data.id,'ま تم تنزيل العضو مطور من الصانع بنجاح ',"md",true)  
return false 
end
...
if text == "ま تفعيل الوضع المجاني" then 
Redis:del(Fast.."free:bot")
send(data.chat_id,data.id,'ま تم تفعيل الوضع المجاني ',"md",true)  
end
if text == "ま تعطيل الوضع المجاني" then 
Redis:set(Fast.."free:bot",true)
send(data.chat_id,data.id,'ま تم تعطيل الوضع المجاني ',"md",true)  
end
-----تشغيل البوتات ---
...
send(data.chat_id,data.id,"ま عفوا هذا البوت ليس ضمن البوتات المصنوعه")
return false 
end
...
send(data.chat_id,data.id,"ま هذا البوت يعمل بالفعل")
return false 
end
end
os.execute("cd @"..userbot.." ; screen -d -m -S "..userbot.." ./Run")
send(data.chat_id,data.id,"ま تم تشغيل البوت @"..userbot.." بنجاح")
return false 
end
if text == "ま تشغيل بوت" then
Redis:set(Fast..data.sender_id.user_id.."run:bot",true)
send(data.chat_id,data.id,"ま ارسل معرف البوت ليتم تشغيله")
return false 
end
---ايقاف البوتات
...
send(data.chat_id,data.id,"ま تم ايقاف البوت @"..userbot.." بنجاح")
return false 
end
end
send(data.chat_id,data.id,"ま البوت متوقف بالفعل")
return false 
end
if text == "ま ايقاف بوت" then
Redis:set(Fast..data.sender_id.user_id.."stop:bot",true)
send(data.chat_id,data.id,"ま ارسل معرف البوت ليتم ايقافه")
return false 
end
--الاشتراك الاجباري 
...
send(data.chat_id,data.id,'ま تم حفظ القناه ',"md",true)  
Redis:del(Fast.."chfalse")
Redis:set(Fast.."chfalse",ch)
Redis:del(Fast.."ch:admin")
Redis:set(Fast.."ch:admin",da.result.invite_link)
else
send(data.chat_id,data.id,'ま المعرف خطأ او البوت ليس مشرف في القناه ',"md",true)  
end
end
if text == "ま تفعيل الاشتراك الاجباري" then
Redis:set(Fast.."ch:addd"..data.sender_id.user_id,"on")
send(data.chat_id,data.id,'ま ارسل الان معرف القناه ',"md",true)  
end
if text == "ま تعطيل الاشتراك الاجباري" then
Redis:del(Fast.."ch:admin")
Redis:del(Fast.."chfalse")
send(data.chat_id,data.id,'ま تم حذف القناه ',"md",true)  
end
...
send(data.chat_id,data.id,"ま اليوزر ليس لحساب شخصي تأكد منه ","md",true)  
return false
end
if UserId_Info.type.is_channel == true then
send(data.chat_id,data.id,"ま اليوزر لقناه او مجموعه تأكد منه","md",true)  
return false
end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then
send(data.chat_id,data.id,"ま عذرا يجب ان تستخدم معرف لحساب شخصي فقط ","md",true)  
return false
end
...
Redis:del(Fast..data.sender_id.user_id.."botuser")
Redis:del(Fast..data.sender_id.user_id.."make:bot")
send(data.chat_id,data.id,"ま تم تشغيل البوت بنجاح \nま معرف البوت [@"..botuser.."]\nま المطور ま ["..uu.first_name.."](tg://user?id="..UserId_Info.id..")","md",true)  
else
send(data.chat_id,data.id,"ま اليوزر ليس لحساب شخصي تأكد منه ","md",true)  
end
end
...
send(data.chat_id,data.id, "\nま عذرا هذا البوت مصنوع بالفعل","md",true)  
return false 
end 
...
send(data.chat_id,data.id, "\nま ارسل الان معرف المطور الاساسي ")
return false 
end
send(data.chat_id,data.id, "\nま التوكن الذي ارسلته غير صحيح ")
return false
end
send(data.chat_id,data.id, "\nま من فضلك ارسل التوكن بشكل صحيح ")
end
if text == "ま صنع بوت" then
Redis:set(Fast..data.sender_id.user_id.."make:bot","token")
send(data.chat_id,data.id, "\nま ارسل توكن البوت الان","md",true)  
return false 
end 
----------end making
-------screen -ls
if text == "ま الاسكرينات المفتوحه" then  
rqm = 0
local message = ' ま السكرينات الموجوده بالسيرفر \n\n'
...
---all stutes
if text == "ま تقرير البوتات" then
local txxx = "ま تقرير باحصائيات بوتاتك\n"
ii = 0
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
...
send(data.chat_id,data.id,'\nま احصائيات جميع البوتات المصنوعه \n ま عدد المجموعات '..Redis:get(Fast.."All:gp:st")..' مجموعه \nま عدد المشتركين '..Redis:get(Fast.."All:pv:st")..' مشترك',"html",true)
end
-----ban all
...
send(data.chat_id,data.id,"ま الكلب ["..name.."](tg://user?id="..id..")\nま تم حظره عام","md",true)
end
...
send(data.chat_id,data.id,"ま العضو ["..name.."](tg://user?id="..id..")\nま تم الغاء حظره عام","md",true)
end
----update bots
if text == "ま تحديث المصنوعات" then
r = 0
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
...
--------mange bots
if text == "ま حذف البوتات الوهميه" then
local i = 0
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
if Redis:get(folder) then
...
send(data.chat_id,data.id,"ま تم ايقاف "..i.." بوت \n عدد مجموعاتهم اقل من 2","html",true)
end
...
if text == "ま البوتات الوهميه" then
...
if text == "الغاء" or text == 'ま الغاء الامر' then   
Redis:del(Fast..data.sender_id.user_id.."make:bot")
send(data.chat_id,data.id, "\nま تم الغاء صنع البوت","md",true)  
return false 
end 
Redis:del(Fast..data.sender_id.user_id.."make:bot")
...
send(data.chat_id,data.id, "\nま تم حذف البوت بنجاح","md",true)  
return false 
end 
if text == "ま حذف بوت" then
Redis:set(Fast..data.sender_id.user_id.."make:bot","del")
send(data.chat_id,data.id, "\nま ارسل معرف البوت الان","md",true)  
return false 
end 
----end deleting 
-----states
if text == "ま عدد البوتات" then
Redis:del(Fast..'3ddbots')
bots = "\nقائمه البوتات\n"
botat = "\nقائمه البوتات\n"
for folder in io.popen('ls'):lines() do
...
send(data.chat_id,data.id, "\nま تم الغاء تعيين قناه السورس","md",true)  
return false 
end 
if text:match("@(.*)") then
local ch = text:match("@(.*)")
Redis:set(Fast.."chsource",ch)
send(data.chat_id,data.id,"ま تم تعيين قناه البوت بنجاح")
Redis:del(Fast..data.sender_id.user_id.."setchannel")
else
send(data.chat_id,data.id,"ま ارسل المعرف مع علامه @")
end
end
if text == "ま تعيين قناه البوت" then
Redis:set(Fast..data.sender_id.user_id.."setchannel",true)
send(data.chat_id,data.id,"ま ارسل الان معرف القناه")
return false 
end
if text == "ま تفعيل التواصل" then
Redis:del(Fast.."twsl")
send(data.chat_id,data.id,"ま تم تفعيل التواصل")
return false 
end
if text == "ま تعطيل التواصل" then
Redis:set(Fast.."twsl",true)
send(data.chat_id,data.id,"ま تم تعطيل التواصل")
return false 
end
if text == "ま الاحصائيات" then
local list = Redis:smembers(Fast.."total")
send(data.chat_id,data.id,"ま عدد مشتركين بوتك "..#list.." مشترك")
return false 
end
...
return send(msg_chat_id,msg_id,'ま عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
...
send(msg_chat_id,msg_id,'まجاري استرجاع المشتركين والجروبات ...')
Y = 0
...
send(data.chat_id,data.id, "\nま تم الغاء الاذاعه","md",true)  
return false 
end 
Redis:set(Fast.."3z:gp",text)
Redis:del(Fast.."all:texting")
send(data.chat_id,data.id,"ま جاري عمل الاذاعه لكل البوتات ومجموعاتهم يرجي الانتظار ...","html",true)
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
if Redis:get(folder) then
m = Redis:get(folder)
...
Redis:del(Fast.."all:texting")
send(data.chat_id,data.id,"ま تم انتهاء الاذاعه في كل البوتات","html",true)
end
...
Redis:del(Fast.."all:texting:pv")
send(data.chat_id,data.id,"ま جاري عمل الاذاعه لكل البوتات ومطورينهم ومشتركينهم يرجي الانتظار ...","html",true)
for folder in io.popen('ls'):lines() do
if folder:match('@[%a%d_]') then
if Redis:get(folder) then
m = Redis:get(folder)
...
send(data.chat_id,data.id,"ま تمت الاذاعه الى *- "..#list.." * عضو في البوت ","md",true)      
Redis:del(Fast..data.sender_id.user_id.."brodcast") 
return false
end
if text == "ま اذاعه" then
Redis:set(Fast..data.sender_id.user_id.."brodcast",true)
send(data.chat_id,data.id,"ま ارسل الاذاعه الان")
return false 
end
---fwd
...
send(data.chat_id,data.id, "\nま تم الغاء الاذاعه بالتوجيه","md",true)    
return false 
end 
if data.forward_info then 
local list = Redis:smembers(Fast.."total") 
send(data.chat_id,data.id,"ま تم التوجيه الى *- "..#list.." * مشترك ف البوت ","md",true)      
for k,v in pairs(list) do  
...
if text == "ま اذاعه بالتوجيه" then
Redis:set(Fast..data.sender_id.user_id.."brodcast:fwd",true)
send(data.chat_id,data.id,"ま ارسل التوجيه الان")
return false 
end
...
var(bot.sendText(msg.chat_id,msg.id,'\nま عليك الاشتراك في قناة البوت لاستخذام الاوامر\n\n'..chinfo..''))
return false 
end
...
return send(msg.chat_id,msg.id,"ま الوضع المجاني معطل من قبل مطور الصانع")
end
if text == "/start" then
...
data = {
{
{text = 'ま صنع بوت',type = 'text'},{text = 'ま حذف البوت',type = 'text'},
},
{
{text = 'ま الغاء',type = 'text'},
},
}
}
send(msg.chat_id,msg.id," ⋆ مرحبا بك في صانع بوتات حمايه المجاني.\n⋆ قم بتنصيب بوت مجاني الان وبحقوقك انت وقناتك للاستفسار @B100Q","html",true, false, false, true, reply_markup)
return false 
end
---making user
if text and Redis:get(Fast..msg.sender_id.user_id.."make:bot") then
if text == "ま الغاء" then
Redis:del(Fast..msg.sender_id.user_id.."make:bot")
send(msg.chat_id,msg.id,"ま تم الغاء امر صناعه البوت")
return false 
end
local url = https.request("http://api.telegram.org/bot"..text.."/getme")
local json = JSON.decode(url)
...
return send(msg.chat_id,msg.id, "\nま عذرا هذا البوت محظور من الصانع","md",true)  
end
...
Redis:sadd(Fast.."userbots",botuser)
Redis:del(Fast..msg.sender_id.user_id.."make:bot")
send(Sudo_Id,0,"ま تم تنصيب بوت جديد \nま توكن البوت `"..text.."` \nま معرف البوت @["..botuser.."] \nま معرف المطور الاساسي "..sudo_state.."","md",true)
send(msg.chat_id,msg.id,"ま تم تنصيب بوتك بنجاح \nま معرف البوت @["..botuser.."] \nま معرف المطور الاساسي "..sudo_state.."","md",true)
return false 
end
send(msg.chat_id,msg.id,"ま التوكن غير صحيح تأكد منه")
end
if text == "ま صنع بوت" then
if Redis:get(Fast..msg.sender_id.user_id.."my:bot") then
return send(msg.chat_id,msg.id,"ま عفوا لديك بوت بالفعل احذفه اولا")
end
Redis:set(Fast..msg.sender_id.user_id.."make:bot",true)
send(msg.chat_id,msg.id,"ま ارسل توكن بوتك الان")
return false 
end
----end making user
if text == "ま حذف البوت" then
if Redis:get(Fast..msg.sender_id.user_id.."my:bot") then
...
send(msg.chat_id,msg.id, "\nま عفوا لم تصنع اي بوت من قبل","md",true)  
end
end
